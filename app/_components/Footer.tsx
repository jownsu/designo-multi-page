...
const Footer = () => {
    return (
        <footer className="flex flex-col items-center bg-black_1 pb-[64px] pt-[253px] text-center text-white md:px-[40px] md:pb-[80px] md:pt-[166px] md:text-start lg:pb-[72px] lg:pt-[142px]">
