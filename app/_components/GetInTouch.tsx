...
const GetInTouch = () => {
    ...
    return (
        <Slide className="absolute top-[-190px] mx-auto flex h-[379px] rounded-[15px] bg-primary bg-[url('/images/shared/desktop/bg-pattern-call-to-action.svg')] bg-[length:250%] bg-[position:-220px] bg-no-repeat px-[20px] md:top-[-264px] md:h-[350px] md:w-[calc(100%-80px)] md:bg-[length:120%] md:bg-[position:0] lg:top-[-220px] lg:h-[292px] lg:max-w-[1111px] lg:bg-[length:80%] lg:bg-right lg:px-[96px]" triggerOnce>
