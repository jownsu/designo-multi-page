...
import BGCirclePattern from "@/public/images/contact/desktop/bg-pattern-hero-desktop.svg";
...
const ContactForm = () => {
    ...
    return (
        <div className="text-white overflow-hidden bg-primary py-[72px] flex flex-col lg:flex-row min-h-[375px] md:rounded-lg md:px-14 relative">
            <BGCirclePattern className="fill-inherit z-0 absolute top-[-135px] left-0 hidden sm:left-[-120px] sm:top-[-100px] md:block"/> 
